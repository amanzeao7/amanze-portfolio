export default function About() {
  return (
    <section id="about" className="fade-up bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 p-6 rounded-lg">
      <h2 className="text-2xl font-semibold">About Me</h2>
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        <div className="md:col-span-1">
          <div className="w-44 h-44 bg-slate-100 dark:bg-gray-700 rounded-lg overflow-hidden">
